python ./fairseq/train.py output/data-bin --task translation \
        --max-tokens 4000 --source-lang zh --target-lang th --update-freq 4 --ddp-backend=no_c10d \
        --user-dir ./userdir/mytransformer --arch mytransformer_base  --label-smoothing 0.1 --fp16 \
