...
@register_model_architecture("mytransformer", "mytransformer_tiny")
...
@register_model_architecture("mytransformer", "mytransformer_base")
...
@register_model_architecture("mytransformer", "mytransformer_big")
